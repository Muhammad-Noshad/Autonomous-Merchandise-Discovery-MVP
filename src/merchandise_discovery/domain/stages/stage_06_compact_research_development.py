...
def reasoning_instructions() -> str:
    ...
    return (
        ...
        "language, emotional tension, and distinctive visual hook. "
        f"{concept_stage.audience_copy_instructions()} Search findings are inspiration for patterns "
        "only: do not copy existing phrases, "
