...
def _demo_output_payload(number: int, evidence: list[EvidenceFixture]) -> dict[str, object]:
    ...
    return {
        ...
        4: {
            ...
            "selected_intersection_ids": [intersection["intersection_id"]],
            "provider_selections_count": 0,
            "summary": "Selected 1 of 1 intersections deterministically for fixture mode.",
        },
...
def get_demo_run() -> RunFixture:
    ...
    stage_definitions = [
        ...
        ("AI Coherence and Research Selection", "Select research-worthy intersections and explain each AI selection."),
        ("Research Selection Compatibility Pass", "Pass through Stage 4's selected research set for historical compatibility."),
